      ...
      >
        <div className="absolute inset-0 pointer-events-none z-0">
          <motion.div
            ...
            className="absolute -top-32 -left-20 w-[500px] h-[500px] rounded-full bg-[#10b981] opacity-20 blur-[110px]"
          />
          <motion.div
            animate={{
              scale: [1, 0.85, 1.15, 1],
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(16,185,129,0.35), rgba(0,174,239,0.15))",
              border: "1px solid rgba(16,185,129,0.3)",
            }}
          >
            <Fish size={30} className="text-[#10b981] relative z-10" strokeWidth={1.8} />
          </motion.div>
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold font-montserrat uppercase tracking-widest bg-[#10b981]/10 text-[#10b981] border border-[#10b981]/20 mb-5">
          ...
          >
            ...
            guinéenne. Nous structurons des circuits d&apos;approvisionnement
            optimisés pour garantir la disponibilité de produits de la mer
            d&apos;une fraîcheur absolue sur les marchés locaux et régionaux.
          </motion.p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <h2 className="font-montserrat font-extrabold text-2xl text-zinc-900 dark:text-white tracking-tight mb-6">
              Notre engagement dans la filière pêche
            </h2>
            <ul className="space-y-4">
              {pointsCles.map((point) => (
                ...
                >
                  <CheckCircle2
                    size={18}
                    className="shrink-0 mt-0.5 text-[#10b981]"
                  />
                  <span>{point}</span>
                </li>
              ))}
